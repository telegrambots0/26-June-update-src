   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("Sorry Sir, You are Banned. Contact -- @SmexyOP")
            return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @SmexyOP...")
         return 1
...
**__Speed__** : {3}/s
**__Time__** : {4}\n\n
**__Powered by [𝙎𝙈𝙀𝙓𝙔 𝙎𝙏𝙊𝙍𝙀 🇮🇳](https://t.me/SmexyStore)__**
"""
